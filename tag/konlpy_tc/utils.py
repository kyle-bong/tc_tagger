...
def concordance(phrase, text, show=False):
    ...
    .. code-block:: python
        ...
        >>> from konlpy_tc.corpus import kolaw
        >>> from konlpy_tc.tag import Mecab
...
if sys.version_info[0] < 3:
    from konlpy_tc import csvutils
    ...
    def csvread(f, encoding='utf-8'):
        ...
        .. code-block:: python
            ...
            >>> from konlpy_tc.utils import csvread
    ...
    def csvwrite(data, f):
        ...
        .. code-block:: python
            ...
            >>> from konlpy_tc.utils import csvwrite
...
if sys.version_info[0] < 3:
    def pprint(obj, **kwargs):
        ...
        .. code-block:: python
            ...
            >>> import pprint, konlpy_tc
            >>> pprint.pprint([u"Print", u"유니코드", u"easily"])
            [u'Print', u'\uc720\ub2c8\ucf54\ub4dc', u'easily']
            >>> konlpy_tc.utils.pprint([u"Print", u"유니코드", u"easily"])
            ['Print', '유니코드', 'easily']

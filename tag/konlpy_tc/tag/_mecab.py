...
class Mecab():
    ...
    In order to use MeCab-ko within konlpy_tc, follow the directions in
    ...
    def __init__(self, dicpath=r'C:\mecab\mecab-ko-dic'):
        try:
            ...
            raise Exception('Install MeCab in order to use it: http://konlpy_tc.org/en/latest/install/')

...
from konlpy_tc import jvm, utils
...
class Komoran():
    ...
    .. code-block:: python
        ...
        오픈소스	NNG
        바람과 함께 사라지다	NNP
        >>> from konlpy_tc.tag import Komoran
    ...
    def __init__(self, jvmpath=None, userdic=None, modelpath=None, max_heap_size=1024):
        ...
        try:
            ...
            raise IOError("Cannot access komoran-dic. Please leave an issue at https://github.com/konlpy_tc/konlpy_tc/issues")
